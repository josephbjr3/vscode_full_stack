...
app.get('/', (req, res) => {
    res.render("home", {name: "Home"}) //note: auto looks in the views folder, don't need to add .ejs
})
app.get('/rand', (req, res) => {
    const num = Math.floor(Math.random() * 10) + 1; 
    res.render("random", {num, name: "Random"}) //note: num = num:num, num is passed into the random.ejs file
})
